...
SRC =	decode.c
SRC_Utils = decodeFile.c readTree.c

OBJ_DIR = obj
SRCS = $(addprefix src/, $(SRC)) $(addprefix src/Utils/, $(SRC_Utils))
...
HOWTO = @echo ${IRed}"To run the program do: ./${NAME} <tree_file.txt> <\"binary\".txt>"${Color_Off}
